...
$reg_year 		= "2007";					// CHANGE THIS EVERY YEAR
$conf_dates		= "June 20-22, 2007";
$conf_domain	= "supernova2007.com";		// NOT IN USE YET 1/4/2007
...
$ch = curl_init("https://certification.authorize.net/gateway/transact.dll"); // URL of gateway for cURL to post to <-- USE THIS ONE FOR TESTING
//TESTING		$ch = curl_init("https://secure.authorize.net/gateway/transact.dll"); 	// <-- USE THIS ONE FOR LIVE CC PROCESSING
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="wrapper">
    <div id="container">
      ...
      <div id="subheader">
        <div id="whartonlogo"><a href="http://www.wharton.upenn.edu/"><img src="http://www.supernova2007.com/i/whartonlogo.jpg" width="110" height="55" alt="Produced in Partnership with Wharton University of Pennsylvania" /></a></div>
        <div id="quote">
      ...
      <div id="leftcolumn">
        ...
        <p><a title="Venue Information and Reserverations" href="http://www.supernova2007.com/go/venue">Venue Information and Reservations</a></p> 
      </div>

      <div id="middlecolumn">
        <img src="http://www.supernova2007.com/i/alexandras_top.jpg" width="394" height="89" alt="Alexandra" />
        <h1>Supernova 2007</h1>
EOQ;
} // NO PLAIN TEXT END
$body .= <<<EOQ
...
We are thrilled you will be joining us at Supernova $reg_year, $conf_dates, in San Francisco, CA. Your confirmed conference registration entitles you to attend: $seminar_description<br><br>

You and all conference participants are invited to our kick-off networking event — <font color="#380169"><b>The Wharton West Reception</b></font> — on Wednesday, June 20, from 5:30pm to 8:30pm at the Wharton West campus. Registration for the main conference will be available at Wharton West all day on June 20, and at the Westin St. Francis Hotel on June 21 and 22, beginning at 7:30am. Please visit our <a href="http://www.supernova2007.com/go/venue">Web site</a> for additional information and maps to the Conference venues.<br><br>
  ...
  <div id="wrapper">
    <div id="container">
	  ...
	  <ul id="navigation">
        ...
        <li><a title="Register" href="https://www.supernovagroup.net/registration/register.php">Register</a></li>
        <li><a title="Speakers" href="http://www.supernova$reg_year.com/go/speakers">Speakers</a></li>
        <li><a title="Sessions" href="http://www.supernova$reg_year.com/go/agenda">Sessions</a></li>
        <li><a title="Workshops" href="http://www.supernova$reg_year.com/go/workshops">Challenge Day </a></li>
        <li><a title="Weblog" href="http://www.supernova$reg_year.com/go/weblog">Weblog</a></li>
        <li><a title="Contact Us" href="http://www.supernova$reg_year.com/go/contact">Contact Us</a></li>
...
global $cc_declined_reason;
	...
	if ($payment_received == "yes" || $payment_received == "n/a")  	// PAYMENT APPROVED OR THEY DIDN'T NEED TO PAY -> GREAT
	{
			...
			Web: <a href="http://www.supernova$reg_year.com/">www.supernova$reg_year.com</a><br /><br />
EOQ;
	}
...
<!-- --
      ...
      <div id="subnav">
	  <a title="Community Connection" href="http://www.werbach.com/supernova2007new/go/community-connection">Community Connection</a><br/>
      <a title="Audio/Video" href="http://www.werbach.com/supernova2007new/go/media-center">Media Center</a><br/>
      <a title="Connected Innovators" href="http://www.werbach.com/supernova2007new/go/connected-innovators">Connected Innovators</a><br/>
      <a id="cohosted" title="TechCrunch" href="http://www.werbach.com/supernova2007new/go/connected-innovators"><img class="right" src="http://www.werbach.com/supernova2006new/i/co-hosted_tc.gif" width="120" height="14" alt="Techcrunch" border="0" /></a><br/><br/>
       <a id="rss" title="RSS Feed" href="http://www.werbach.com/supernova2007new/go/weblog/rss_2.0"><img class="left" src="http://www.werbach.com/supernova2006new/i/rssicon.jpg" width="28" height="28" alt="RSS Icon" /> Subscribe to RSS</a>

	   </div>
		
        <div class="sponsors">Premium Sponsor</div>
        <img src="http://www.werbach.com/supernova2007new/i/att.jpg" width="95" height="45" alt="ATT" />
        <br />
        <p class="purple">A complete list of sponsors is available on our <a href="http://www.werbach.com/supernova2007new/go/sponsors">sponsors page</a>. For sponsorsorship information, please <a href="mailto:sponsor@supernova2007.com">email us</a>, or view our <a href="./../downloads/prospectus.pdf">Sponsor Prospectus</a> (PDF).</p>  <br /><br /><br />
