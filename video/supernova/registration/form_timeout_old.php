...
<td width="780" bgcolor="#FFFFFF">
	...
	<tr>
	<td width="304" height="155" valign="top"><a href="http://www.supernova2005.com"><img src="../images_reg/logo.gif" width="304" height="155" alt="Home" border="0"></a></td>
...
<p><img src="../images_reg/head_register.gif" width="502" height="50" alt="Register">
	<br>
	<span class="form_label"> For security purposes, your registration session has timed out. Please click <a href="register.php">here</a> to go back to the form. <br>
	</span><br>
	<!-- ----------------- END FORM ABOVE ------------------------ -->
    </p>
</td>
