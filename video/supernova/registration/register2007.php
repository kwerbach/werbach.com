  ...
  <div id="wrapper">
    <div id="container">
      ...
      <ul id="navigation">
        ...
        <li><a title="Speakers" href="http://www.supernova2007.com/go/speakers">Speakers</a></li>
        <li><a title="Agenda" href="http://www.supernova2007.com/go/agenda">Sessions</a></li>
        <li><a title="Challenge Day" 
href="http://www.supernova2007.com/go/workshops">Challenge Day </a></li>
        <li><a title="Sponsors" href="http://www.supernova2007.com/go/sponsors">Sponsors</a></li>
        <li><a title="Weblog" href="http://www.supernova2007.com/go/weblog">Weblog</a></li>
        <li><a title="Contact Us" href="http://www.supernova2007.com/go/contact">Contact Us</a></li>
      </ul>
      <div id="leftcolumn">
        ...
        <br />
        <br />
        <p><a title="Venue Information and Reserverations" 
href="http://www.supernova2007.com//go/venue">Venue Information and 
Reservations</a></p>
      </div>
          ...
          <form action="confirm.php" method="post" name="form1" id="form1" onsubmit="return validate()">
            ...
            <table cellpadding="3" cellspacing="1">
              <tr bgcolor="#F7D388">
                ...
                <td align="center" valign="center"><strong>Early Bird </strong></td>
                <td align="center" valign="center"><span class="form_label"><strong>Regular</strong></span></td>
              </tr>
              <tr bgcolor="#FCEED0">
                <td><input name="seminar_event" type="radio" value="Wharton West Challenge Day" style="background : #FCEED0" onclick="set_base_price(this.value);calc_price();set_cookie(this.name, this.value, 30);" /></td>
                <td><span class="form_label"> <strong>Wharton West Challenge Day</strong><br />
              Access to all sessions on June 20</span></td>
                <td align="center" valign="top"><span class="form_label">$495</span></td>
                <td align="center" valign="top"> <span class="form_label"> $695 </span></td>
              </tr>
              <tr bgcolor="#FCEED0">
                <td><input name="seminar_event" type="radio" value="2-day Conference Package" style="background : #FCEED0" onclick="set_base_price(this.value);calc_price();set_cookie(this.name, this.value, 30);" /></td>
                <td><span class="form_label"> <strong>2-day Conference Package</strong><br />
              Access to all sessions/events at St. Francis June 21 - 22</span></td>
                <td align="center" valign="top" class="form_label">$1,795</td>
                <td align="center" valign="top" class="form_label">$2,095</td>
              </tr>
              <tr bgcolor="#FCEED0">
              ...
              All Conference events June 20 - 22</span></td>
                <td align="center" valign="top" class="form_label">$2,095</td>
                <td align="center" valign="top" class="form_label">$2,595</td>
              </tr>
            </table>
            <p> <span class="form_label">
              <!-- ----------------- BEGIN FORM BELOW ------------------------ -->
          The cut-off deadline for Early Bird registration is May 11, 2007. On-site registration rates are higher than those listed here. <br />
          <br />
            ...
            <table  border="1" cellpadding="5" cellspacing="0" bordercolor="#FFCC99">
              <tr>
                <td><p class="form_label"><strong>Networking Event RSVP: </strong><br />
                        <br />
                All conference participants are invited to our kick-off 
networking event on Wednesday, June 20, from 5:30-8:30pm at the 
Wharton West facility.<br />
                <br />
            ...
            <table>
              ...
              <input name="payment_method" type="radio" value="credit card" onclick="set_cookie(this.name, this.value, 30);" checked="checked" />
              credit card
              ...
              <tr>
                <td class="form_label"> <br />
                    ...
                    <p><strong>Press/analyst registration:</strong> If you are interested in Supernova press/analyst passes, please <a href="mailto:info@supernovagroup.net">email us</a> with full details on your affiliation. We evaluate each application individually. <br />
                        <strong><br />
                Cancellation Policy:</strong> Written cancellations received before May 11, 2007 will be accepted subject to a service charge of $250. Subsequent cancellations are liable for the full-conference registration fee. Substitutions can be done at anytime prior to the conference. Please send email to <a href="mailto:info@supernovagroup.net">info@supernovagroup.net</a> if you would like to make a substitution. <br />
                <br />
...
{
	$cutoff_date = getdate(mktime(0,0,0,5,14,2007));  	// NO MORE EARLYBIRD @ 12:00 AM
...
EOQ;
	...
	else  													// EARLYBIRD RATES BELOW
	{
		echo <<<EOQ
			switch(val)
			{
				case "Wharton West Challenge Day" : // WAS "Wharton West Workshop Day"
				  base_price = "495.00";
				  break; 
				case "2-day Conference Package" : 		// WAS "2-day Main Conference"
				  base_price = "1795.00";
				  break; 
				case "Full Conference" : 
				  base_price = "2095.00";
