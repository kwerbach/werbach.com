  ...
  <div id="wrapper">
    <div id="container">
	  ...
	  <ul id="navigation">
        ...
        <li><a title="Sessions" href="http://www.supernova<?php echo $reg_year; ?>.com/go/agenda">Agenda</a></li>
        <li><a title="Workshops" href="http://www.supernova<?php echo $reg_year; ?>.com/go/workshops">Challenge Days</a></li>
...
<p>	<span class="form_label"> For security purposes, your registration session has timed out. Please click <a href="register.php">here</a> to go back to the form. <br>
	</span><br></p>
