<?php 
	...
	$MM_phaktconn_HOSTNAME = "your.database.server";
	...
	$MM_phaktconn_USERNAME = "username";
	$MM_phaktconn_PASSWORD = "password";
	...
	if($MM_phaktconn_DBTYPE == "access" || $MM_phaktconn_DBTYPE == "odbc"){
		if($MM_phaktconn_CTYPE == "P"){
			...
			$MM_phaktconn_LOCALE);
	} else if (($MM_phaktconn_DBTYPE == "ibase") or ($MM_phaktconn_DBTYPE == "firebird")) {
		if($MM_phaktconn_CTYPE == "P"){
