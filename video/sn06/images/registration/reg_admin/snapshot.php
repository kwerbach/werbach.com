...
echo one_value("count(*)", " WHERE date_registered < '2005-05-14'", "&#8226; Number of early birds: ");
...
{
	$query = "select $field_name from supernova_2005 " . $where_clause;
...
{
	$query = "select " . $field_name . " as the_field from supernova_2005 " . $where_clause;
	$result = safe_query($query);
	if ($result)
	{
