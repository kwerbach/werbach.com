...
<p>	<span class="form_label">
	<!-- ----------------- BEGIN FORM BELOW ------------------------ -->
	<span class="required">* </span>indicates a required field</span></p>
<p><span class="form_label">The cut-off
	 deadline for Early Bird registration is May 13, 2005. For information
	 about press   registration or other questions, please
	 contact us at <a href="mailto:info@supernovagroup.net">info@supernovagroup.net</a>.<br>
	 <br>
	 </span> </p>
...
<table>
	<tr>
		...
		print out the registration form, complete it and fax it to: <strong>(877) 241-1465</strong>. <strong><br>
		      <br>
		      Hotel registration:</strong> please go to our <a href="../venue.htm">Venue</a> page for information on how to register for rooms at the Palace Hotel at a special discounted rate.<br>
			     <strong><br>
			Press registration:</strong> to apply for complimentary press registration,
			please	send  email describing your media organization and
			coverage areas to <a href="mailto:press@supernovagroup.net">press@supernovagroup.net</a>.<br>
            <strong><br>
           </strong><strong>Cancellation policy:</strong> Written cancellations
           received before May 13, 2005 will be accepted subject to a service
           charge of $250. Subsequent cancellations are liable for the
           full-conference registration fee. Substitutions can be done
           at anytime prior to the conference. Please send email to <a href="mailto:info@supernovagroup.net">info@supernovagroup.net</a> if
           you would like to make a substitution.
			<br>
			<br>
