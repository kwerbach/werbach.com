...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
	  <td valign="top"><select name="priority_code" id="priority_code">
        <?php
		$query = "SELECT distinct priority_code FROM sn_priority_codes WHERE for_event = 'supernova2006' AND price = 0.00 ORDER BY priority_code";
...
//	$query = "SELECT ID, CONCAT(last,', ',first, ' (', LEFT(company, 10), '...)') AS name FROM people " . $where_clause . ' ORDER BY last,company';
	...
	<tr>
	  <td>
	  	<input type="hidden" name="category" id="category" value="attendee">
