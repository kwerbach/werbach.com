        ...
        <td width="663">
          <table border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="646" height="24" bgcolor="#FFA813" valign="middle"> <font face="verdana,arial" size="2" color="#FFFFFF"> <a href="snapshot.php" style="color:FFFFFF"><b>Snapshot</b></a> | <a href="attendees.php" style="color:FFFFFF"><b>Attendees</b></a> | <a href="download.php" style="color:FFFFFF"><b>Download
                  </b></a> | <a href="https://www.supernova2005.com/registration/reg_admin/add_existing/" style="color:FFFFFF"><strong>Add
                  New</strong></a> | <a href="priority_codes.php" style="color:FFFFFF"><b>Priority
                  Codes </b></a> | <a href="aliases.php" style="color:FFFFFF"><b>Aliases </b></a> | <a href="../register.php" style="color:FFFFFF"><b>Reg.
              Form</b></a> </font></td>
            </tr>
            <tr>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	...
	?>
		...
		<td width="23%"><select name="start_date">
          ...
          <?php	
		$reg_start = getdate(mktime(0, 0, 0, 1, 11, 2006));
		$reg_end = getdate(mktime(0, 0, 0, 6, 25, 2006));
		...
		for($i= -10;$i < $reg_days+10; $i++)
		{
			...
			$selected = "";
			$tomorrow = date("m/d/Y", mktime(0, 0, 0, 2, 16+$i, 2006));
...
?>
		...
		for($i= $reg_days + 7;$i > 0; $i--)  // 10 DAYS BEFORE THE START OF REGISTEING
		{
			...
			$selected = "";
			$yesterday = date("m/d/Y", mktime(0, 0, 0, 6, 25-$i, 2006));
