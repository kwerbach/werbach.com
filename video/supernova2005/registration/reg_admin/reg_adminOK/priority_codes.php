...
switch ($_POST["mode"]) {		// CHECK MODE AND DO THE RIGHT THING
	case "delete selected":
	   ...
	   break;
	case "add":
		$query = "INSERT  sn_priority_codes (priority_code, category, description, price) VALUES ('" . sqlize($_POST["add_priority_code"]) . "', '" . $_POST["add_category"] . "', '" . $_POST["add_description"] . "', '" . $_POST["add_category"] . "')";
		safe_query($query);
		break;
	case "update":
...
//		$query = "UPDATE sn_priority_codes SET price = '" . $_POST["update_price"] . "', category = '" . $_POST["update_category"] . "', last_modified = '" . date("Y-m-d H:i:s") ."' WHERE priority_code_id = '" . $_POST["update_priority_code"] . "' LIMIT 1";
		$query = "UPDATE sn_priority_codes SET " . $update_sql_price . $update_sql_category . $update_sql_description . " last_modified = '" . date("Y-m-d H:i:s") ."' WHERE priority_code_id = '" . $_POST["update_priority_code"] . "' LIMIT 1";
		safe_query($query);
		break;
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="form_label"><input name="add_priority_code" type="text" id="add_priority_code" size="15" maxlength="25"></td>
		<td class="form_label"><input name="add_category" type="text" id="add_category" size="15" maxlength="25"></td>
		<td class="form_label"><input name="add_description" type="text" id="add_description" size="15" maxlength="25"></td>
		<td class="form_label">$
	...
	?>
		...
		<td class="form_label"><input name="update_category" type="text" id="update_category" size="15" maxlength="25"></td>
		<td class="form_label"><input name="update_description" type="text" id="update_description" size="15" maxlength="25"></td>
		<td class="form_label">$
