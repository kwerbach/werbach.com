<?php
header("Location: https://www.supernovagroup.net/registration/register.php");
require "inc_db.php";
dbconnect();
...
<table>
	<tr>
		<td colspan="2" class="form_label">
		  <p><br>
		      <img src="../images/hrfade.gif" width="480" height="4" alt=""><br>
		      <br>
		  ...
		  <br>
		  <br>
		  <strong>Hotel registration:</strong> online registration for discounted rooms at the Palace Hotel will be available via the <a href="../venue.htm">Venue</a> page after February 1, 2006.</p>
