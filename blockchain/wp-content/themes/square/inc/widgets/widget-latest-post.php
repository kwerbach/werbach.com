...
class Square_Latest_Posts extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array('description' => __('A widget to display latest post with thumbnail.', 'square-plus'));
