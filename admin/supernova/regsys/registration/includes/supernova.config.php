...
// ERROR DEFINITIONS
	...
	// PARAMETER ERRORS
	define('ERR_151','Died with: Error 151 - No data table was provided for output!');
	define('ERR_152','Died with: Error 152 - Filter field count does not match filter value count!');	
