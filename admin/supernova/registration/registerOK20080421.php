...
function calc_price()
{
	...
	else
	{
		...
		{ 
				...
				document.form1.amount.value = 1000.00; 	 	 	 	
				document.form1.category.value = "attendee"; 	 	 	 	
				break; 
 	 	 					case "press08" : 
  	 	 	 	
				document.form1.amount.value = 0.00; 	 	 	 	
				document.form1.category.value = "press"; 	 	 	 	
				break; 
 	 	 					case "staff08" : 
  	 	 	 	
				document.form1.amount.value = 0.00; 	 	 	 	
				document.form1.category.value = "staff"; 	 	 	 	
				break; 
 	 	 					case "early08" : 
  	 	 	 	
				document.form1.amount.value = 1295.00; 	 	 	 	
				document.form1.category.value = "attendee"; 	 	 	 	
				break; 
 	 	 					case "testdave" : 
				...
				document.form1.amount.value = 295.00; 	 	 	 	
				document.form1.category.value = "attendee"; 	 	 	 	
				break; 
 	 	 					case "early bird" : 
...
-->
            ...
            <table  border="0" cellspacing="0">
              ...
              <p><strong>Special Meal Request:</strong>  I require vegetarian meals.  <input name="meals" type="checkbox" id="meals" value="vegetarian" onclick="single_option_cookie(this.name, this.value, this.checked);" /></p>
            <br />
