...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Supernova <?php echo $reg_yearl ?> - Register</title>
...
function form_timeout()
{
  ...
  <body onLoad="init();setTimeout('form_timeout()', 3600000);">
    ...
    <div id="container">
      ...
      <a title="Media Center" href="http://www.werbach.com/supernova2006new/go/media-center">Media Center</a><br/>
...
<table cellpadding="3" cellspacing="1">
	...
	<tr bgcolor="#FCEED0">
		<td><input name="seminar_event" type="radio" value="Wharton West Connected Challenges" style="background : #FCEED0" onClick="set_base_price(this.value);calc_price();set_cookie(this.name, this.value, 30);"></td>
		<td><span class="form_label">
		<strong>Wharton West Connected Challenges</strong><br>
               Access to all workshops on June 21</span></td>
		<td align="center" valign="top"><span class="form_label">$495</span></td>
		<td align="center" valign="top">
			<span class="form_label"> $695 
</span></td>
	</tr>
	<tr bgcolor="#FCEED0">
		...
		<td><span class="form_label">               
			<strong>2-day Conference Package</strong><br>
	...
	<tr bgcolor="#FCEED0">
		...
		<td><span class="form_label">               
		<strong>Full Conference</strong> <br>
               Wharton and all Conference events June 20 - 22</span></td>
		<td align="center" valign="top" class="form_label">$2,095</td>
...
<p>	<span class="form_label">
	<!-- ----------------- BEGIN FORM BELOW ------------------------ -->
	The cut-off deadline for Early Bird registration is May 11, 2007.

On-site registration rates are higher than those listed here. <br>
	<br>
...
<table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#FFCC99">
	<tr>
		<td><p class="form_label"><strong>Special Meal Request: </strong><br>
		    <br>
...
<table>
	<tr>
		...
		<br>		<p><strong>You may also submit registration information by fax</strong>. Please print out the registration form, complete it and fax it to: <strong>(877) 241-1465</strong>. <br>
            <br>
            <strong>Hotel registration:</strong> online registration for
            discounted rooms at the Palace Hotel are available via the <a href="http://www.werbach.com/supernova2006new/go/venue">Venue</a> page.</p>
...
{
	$cutoff_date = getdate(mktime(0,0,0,5,11,2007));  	// NO MORE EARLYBIRD @ 12:00 AM
	...
	if($today[0] >= $cutoff_date[0])					// FULL PRICE
	{
		echo <<<EOQ
			switch(val)
			{
				case "Wharton West Connected Challenges" : 
				  base_price = "695.00";
				  break; 
...
EOQ;
	...
	else  													// EARLYBIRD RATES BELOW
	{
		echo <<<EOQ
			switch(val)
			{
				case "Wharton West Connected Challenges" : // WAS "Wharton West Workshop Day"
				  base_price = "495.00";
				  break; 
