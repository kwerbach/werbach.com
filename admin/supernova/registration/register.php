  ...
  <div id="wrapper">
    <div id="container">
      ...
      <ul id="navigation">
        ...
        <li><a title="Agenda" href="http://www.supernova<?php echo $reg_year; ?>.com/go/agenda">Agenda</a></li>
        <li><a title="Challenge Days" href="http://www.supernova<?php echo $reg_year; ?>.com/go/workshops">Challenge Days</a></li>
...
<!--<p>There is <strong>one conference package</strong> for Supernova 2008 attendees - it includes an opening  general session and Networking Gala the evening of June 16, 2008, at the <a href="http://www.ahl-missionbay.com/" target="_blank">Mission Bay Conference Center</a>, San Francisco, CA, and; a series of interactive “Challenge” sessions and reception on June 17 – 18, at the <a href="http://www.wharton.upenn.edu/campus/wharton_west/" target="_blank">Wharton West Campus</a>, San Francisco, CA. </p>-->
  <!-- BEGIN CONF OPTIONS -->
          ...
          <form action="confirm<?php echo "$is_test"; ?>.php" method="post" name="form1" id="form1" onsubmit="return validate()">
            <p> To register, please select the conference package below and  then complete the following form and submit the information.<span class="form_label"><br />
                  <br />
            </span> </p>
            <table cellpadding="3" cellspacing="1">
              ...
              Includes all sessions/events at Mission Bay Conference Center and Wharton West</span></td>
                <td align="center" valign="top" class="form_label">$1,695</td>
              </tr>
            </table>
<!-- END CONF OPTIONS -->			
            <p> <span class="form_label">
<!-- ----------------- BEGIN FORM BELOW ------------------------ -->
          <!--The cut-off deadline for Early Bird registration is May 5, 2008. On-site registration rates are higher than those listed here.  --><br />
...
<span id="paying" style="visibility:visible;">
            ...
            <!-- END PAYMENT OPTIONS -->
            <p align="center">
              <input type="submit" name="submit" value="Submit Registration<?php echo $is_test; ?>" class="button" /> 
            </p>
            <table>
              <tr>
                <td class="form_label"> <br />
                    <img src="../images_reg/hrfade.gif" width="48" height="4" alt="" />
						...
						<br />
						<br />
						<strong>Hotel registration:</strong> special hotel rates will be made available for hotels  close to the Supernova <a href="http://www.supernova2008.com/go/venue">venues</a>. Please check back soon for more information.
						<br />
						<br />
