	...
	*/
		...
		*/
		...
		'bfa_content_nav' => array( 
			...
			'examples' => array(
				...
				'<?php bfa_content_nav( multinav1 ); ?>' => __( 'Displays a numbered navigation on multi post pages assigning the <nav...> an id of "multinav1"', 'montezuma' ),
				'<?php bfa_content_nav( mid_size=2&id=multinav1 ); ?>' => __( 'Displays a numbered navigation on multi post pages assigning the <nav...> an id of "multinav1" and 2 numbers to either side of current page, but not including current page.', 'montezuma' ),
			),
		
			'info' => __( 'For other options see http://codex.wordpress.org/Function_Reference/paginate_links. NOTE: This should only be used on multi post pages (index, tag, category, search...) - NOT on single post pages 
	...
	$wl_loop = array(
		...
		'the_post_thumbnail' => array( 
			'type' => 'single',
			'examples' => array(
				'<?php the_post_thumbnail(); ?>' => __( "Displays the post thumbnail using the WordPress 'the_post_thumbnail()' function.", 'montezuma' ),
			),
			'info' => __( "In some cases you may wish to use the WordPress function 'the_post_thumbnail()' 
					to displays the posts thumbnails instead of bfa_thumb(). Refer to the WordPress Codex for 
					the usage and parameter information.", 'montezuma' ),
		),
