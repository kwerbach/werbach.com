...
dbconnect();
$sn2005_fields = array("seminar_event","showcase","priority_code","category","amount","email_format","status","payment_method","payment_received","new_person","last_modified");  // SUPERNOVA_2005 FIELDS TO BE UPDATED
...
<!-- START CONTENT -->
	...
	$query = "SELECT people.*, supernova_2005.* 
				...
				WHERE supernova_2005.people_id = " . $_GET["people_id"];
...
function update_sn($sn_arr)
{
	...
	$sql_sn2005 = "UPDATE supernova_2005 SET " . $update_sn2005_fields . " WHERE people_id = '" . $_POST["people_id"] . "' LIMIT 1"; // UPDATE SQL
