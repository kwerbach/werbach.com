<?php
	...
	if(!empty($free_plugins)) {
		...
		<p><?php echo esc_html__('Please Install all the plugins. Although these plugins are complementary, we encourage to install theme to use the theme to full extent', 'square'); ?></p>
				...
				<div class="recom-plugin-wrap">
					...
					<div class="plugin-title-install clearfix">
						...
						<span class="plugin-btn-wrapper">
							<?php 
							if ( $this->square_check_installed_plugin( $slug, $filename ) && !$this->square_check_plugin_active_state( $slug, $filename ) ) : ?>
							...
							<?php 
							elseif( $this->square_check_installed_plugin( $slug, $filename ) ) : ?>
