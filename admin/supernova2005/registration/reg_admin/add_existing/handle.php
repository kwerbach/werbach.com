...
//	$insert_sn_reg_values = "'" . $ID . "', ";
	$insert_sn_reg_values .= "'Full Conference', ";
	$insert_sn_reg_values .= "'" . $_POST["priority_code"] . "', ";
	$insert_sn_reg_values .= "'" . $_POST["category"] . "', ";
	$insert_sn_reg_values .= "'" . date("Y-m-d") . "', ";
	$insert_sn_reg_values .= "'registered', ";
	$insert_sn_reg_values .= "'yes', ";
...
function create_sn_email_alais($ID)
{
	...
	$email_alias = $row['first'] . "_" . $row['last'] .  ltrim($row['ID'] + 17, "0") . "@supernova2006.com";
	...
	$insert_alias_values .= "'Supernova 2006', ";
