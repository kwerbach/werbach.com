...
//        }
    ...
    public static function custom_admin_pointers()
    {
        ...
        $new_pointer_content .= "This update fixes a compatibility issue with Contact Forms 7 for both free and <a target=_blank href=" . self::$epbase . '/dashboard/pro-easy-video-analytics.aspx?ref=frompointer' . ">Pro versions</a>.";
