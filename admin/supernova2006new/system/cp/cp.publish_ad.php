...
//=====================================================================
	...
	function update_category_fields()
	{
        ...
        // Field name must be unique for each category group
		
		if ($edit == FALSE)
		{
	        $query = $DB->query("SELECT COUNT(*) AS count FROM exp_category_fields WHERE group_id = '".$DB->escape_str($group_id)."' AND field_name = '".$DB->escape_str($_POST['field_name'])."'");
...
SCRIPPITYDOO;
        ...
        $this->category_tree('list', $group_id, $parent_id);
