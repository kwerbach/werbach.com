...
'metaweblog_deleted' =>
"MetaWeblog API Configruation Deleted",
...
a webpage with all pMCode and file directories rendered.",
...
"Relatively few weblog editors allow this option and you may not wish to allow uploads
over the API, so setting to 'None' will prevent any file uploads via weblog editor.",
