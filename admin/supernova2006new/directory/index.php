...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>Supernova <?php echo $reg_year; ?> - Email Directory</title>
  ...
  <div id="wrapper">
    <div id="container">
      ...
      <div id="leftcolumn">
        ...
        <h2>June 16-18, 2007</h2>
        <h6>San Francisco, CA</h6>
        <p><a title="Venue Information and Reserverations" href="http://www.supernova<?php echo $reg_year; ?>.com/go/venue">Venue Information and Reservations</a></p> 
...
<div>    
  <p>To facilitate networking, while protecting your privacy, we have created temporary email 
  aliases for all Supernova <?php echo $reg_year; ?> attendees pre-registered as of <?php echo $pre_reg_end; ?>. Email sent to 
  these aliases will forward to the recipient's personal address. Thus, you retain control 
  over whether to give out your "real" address.  This page is only accessible to Supernova 
  <?php echo $reg_year; ?> attendees.
  
The aliases will remain operational for one month following Supernova. If you would like 
  your email alias de-activated sooner, please send a message to email@supernova<?php echo $reg_year; ?>.com.</p>
  <p><strong>Please only use these email aliases for personal, individual messages. They are not to be used for unsolicited marketing, or any form of bulk communications.</strong></p>
</div>
<br />
<?php
	show_table();
...
function show_table()
{
	...
	$query = "SELECT DISTINCT people.first, people.last, people.company, email_aliases.email_alias
				...
				WHERE email_aliases.email_alias LIKE '%". $reg_year .".com'
	...
	if ($result)
		{
			...
			print <<<EOQ
				<tr valign="top" bgcolor="$bg_color">
				  ...
				  <td><font size="2"><a href="mailto:$email_alias?subject=Supernova%20$reg_year">$email_alias</a></font></td>
				</tr>
EOQ;
			}
			echo "</table>";
