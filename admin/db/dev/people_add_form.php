...
--> </td>
      ...
      <tr>
        <td width="30%" colspan="2" bgcolor="#FFFFCC"><font size="+1"><strong>
          ...
          <input class="fields" type="text" name="first" size="40" tabindex=1>
</strong></font></td>
        <td width="10%" bgcolor="#FFFFCC"><font size="+1"><strong>
          <span class="fieldname2">middle</span><br>
          <input class="fields" type="text" name="middle" size="25" tabindex=2>
</strong></font></td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="29%" bgcolor="#FFFFCC"><font size="+1"><strong>
          <span class="fieldname2">email</span><br>
          <input class="fields" type="text" name="email" size="40" tabindex=4>
        </strong></font></td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <tr>
        ...
        <td width="29%" bgcolor="#FFFFFF">Website:
            <input class="fields" type="text" name="website" size="40" tabindex=18>
        </td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <tr>
        ...
        <td width="29%" bgcolor="#FFFFFF">Blog:
            <input class="fields" type="text" name="blog" size="40" tabindex=19>
        </td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <tr>
        <td colspan="3" bgcolor="#FFFFFF">Title:
            <input class="fields" type="text" name="title" size="60" tabindex=5>
</td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="29%" bgcolor="#FFFFFF">RSS:
            <input class="fields" type="text" name="rss" size="40" tabindex=20>
        </td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <tr>
        <td colspan="3" bgcolor="#FFFFFF">Company:
            <input class="fields" type="text" name="company" size="60" tabindex=6>
</td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="29%" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <tr>
        ...
        <td width="29%" bgcolor="#FFFFFF">Asst. Name:
            <input class="fields" type="text" name="asst_name" size="40" tabindex=21>
        </td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="27%" bgcolor="#FFFFFF">&nbsp;</td>
      </tr>
      <tr>
        ...
        <td width="29%" bgcolor="#FFFFFF">Asst. Phone:
            <input class="fields" type="text" name="asst_phone" size="40" tabindex=22>
        </td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="27%" bgcolor="#FFFFFF">&nbsp;</td>
      </tr>
      <tr>
        <td width="28%" bgcolor="#FFFFFF">City:
            <input class="fields" type="text" name="city" size="40" tabindex=9>
        </td>
        <td width="5%" bgcolor="#FFFFFF">State:
            <input class="fields" type="text" name="province" size="15" tabindex=10>
</td>
      ...
      <tr>
        <td colspan="3" bgcolor="#FFFFFF">Phone:
            <input class="fields" type="text" name="phone" size="25" tabindex=13>
</td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
...
?>
      ...
      <tr>
        <td colspan="3" bgcolor="#FFFFFF">Fax:&nbsp;
            <input class="fields" type="text" name="fax" size="25" tabindex=14>
</td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <tr>
        <td colspan="3" bgcolor="#FFFFFF">Cell:
            <input class="fields" type="text" name="cellphone" size="25" tabindex=15>
</td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
...
?>
      ...
      <tr>
        <td colspan="3" bgcolor="#FFFFFF">Home:
            <input class="fields" type="text" name="home_phone" size="25" tabindex=16>
        </td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="29%" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
...
editor_generate('comments');
          ...
          */ ?>
            <textarea class="fields" name="comments" cols="60" rows="8" tabindex=17></textarea>
