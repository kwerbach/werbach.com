...
<input type="submit" name="add" value="Update Record">
	...
	<td class="button">
			  ...
			  <td>&nbsp;</td>
			  <td><div align="Center"><a class="button" href="mailing-label.php?key=<?=$key?>&itemNumber=<?=$itemNumber?>">show mailing label</a>
<a class="button" href='<?=$backToSearch?>'>Back to search results</a></div></td>
	</tr>
	<tr>
    ...
    <tr>
      ...
      <td width="10%" bgcolor="#FFFFCC">Middle:<br><font size="+1"><strong>
        <input class="fields" type="text" name="middle" value="<?=$middle?>" size="20" tabindex=2>
      </strong></font></td>
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
...
?>
    ...
    <tr>
      ...
      <td width="29%" bgcolor="#FFFFFF">RSS:
          <input class="fields" type="text" name="rss" value="<?=$rss?>" size="40" tabindex=20></td>
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
...
?>
    ...
    <tr>
      ...
      <td width="29%" bgcolor="#FFFFFF">Asst. Phone:
          <input class="fields" type="text" name="asst_phone" value="<?=$asst_phone?>" size="40" tabindex=22>
</td>
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="27%" bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td width="5%" bgcolor="#FFFFFF">State:
          <input class="fields" type="text" name="province" value="<?=$province?>" size="15" tabindex=10>
</td>
...
?>
    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF">Fax:&nbsp;
        <input class="fields" type="text" name="fax" value="<?=$fax?>" size="25" tabindex=14>
      </td>
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
...
?>
    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF">Cell:
          <input class="fields" type="text" name="cellphone" value="<?=$cellphone?>" size="25" tabindex=15>
</td>
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
...
?>
    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF">Home:
          <input class="fields" type="text" name="home_phone" value="<?=$home_phone?>" size="25" tabindex=16></td>
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="29%" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="27%" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr>
      <td height="50" colspan="5" bgcolor="#FFFFFF">Comments<br>
          <textarea class="fields" name="comments" cols="60" rows="8" tabindex=17><?=$comments?>
          </textarea>
