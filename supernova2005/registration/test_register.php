...
<body bgcolor="#380169" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0" onLoad="init();setTimeout('form_timeout()', 3600000) ">
...
<td width="780" bgcolor="#FFFFFF">
	...
	<br>
	<br>
	<a href="../buzz.htm" style="color:7E7E7E">Press Buzz </a>
	<br>
	<br>
	<a href="../venue.htm" style="color:7E7E7E" title="Information on the Palace Hotel and maps to Wharton West">Venue</a>
	<br><br><br><br><br><br>
	<img src="../images/palacehotel06.jpg" width="111" height="189" alt="Palace Hotel">
	<br><br><br>
	<a href="http://www.wharton.upenn.edu/campus/wharton_west"><img src="../images/whartonwest06.jpg" width"111" height"215" alt="Wharton West" border="0"></a>
	<br><br>
	</td>
	<td width="5"></td>
...
<form action="test_confirm.php" method="post" name="form1" onSubmit="return validate()">
<p><img src="../images/head_register.gif" width="502" height="50" alt="Register"><br>
	<span class="form_label">To register, please select a  conference package and then complete and submit the information below. <br>
	<br>
	</span>
...
<p>	<table width="100%"  border="0" cellspacing="0">
	...
	<br><img src="../images/hrfade.gif" width="480" height="4" alt=""><br>
<!-- START CONTACT INFO -->	
	<table width="100%">
	<tr>
...
<table>
	<tr>
		...
		print out the registration form, complete it and fax it to: <strong>(877) 241-1465</strong>. 
		<br>
		<br>
		<strong>Hotel registration:</strong> online registration for discounted rooms at the Palace Hotel will be available via the <a href="../venue.htm">Venue</a> page after January 15, 2006.<br>
			     <strong><br>
			Cancellation Policy:</strong> Written cancellations received before May 12, 2006 will be accepted subject to a service charge of $250. Subsequent cancellations are liable for the full-conference registration fee. Substitutions can be done at anytime prior to the conference. Please send email to <a href="mailto:info@supernovagroup.net">info@supernovagroup.net</a> if you would like to make a substitution.
			<br>
			<br>
...
<!-- ----------------- SPONSOR AREA ------------------------ -->
		<font face="verdana,arial" size="1" color="#FFA813"><b>PRODUCED IN PARTNERSHIP WITH</b></font>
		<br>
		<a href="http://www.wharton.upenn.edu"><img src="../images/logo_wharton.gif" width="119" height="48" alt="The Wharton School" border="0"></a>
		<br><br>
		<font face="verdana,arial" size="1" color="#FFA813"><b><!-- PREMIER SPONSOR</b></font><br>
		<a href="http://www.att.com"><img src="../images/logo_at&t.gif" alt="AT&T" width="125" height="48" border="0"></a></p>
<br><p>
		<font face="verdana,arial" size="1" color="#FFA813"><b>PROGRAM SPONSORS</b></font><br>
            <a href="http://www.silkroadtech.com"><img src="../images/SilkWare125w.gif" alt="SilkRoad" border="0"></a></p>
			 --><br>	
