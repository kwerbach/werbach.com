...
function insert_sn_reg()	// INSERT PEOPLE INTO THE REGISTRATION TABLE
{
	...
	$sn_reg_fields = array("seminar_event","showcase","meals","priority_code","category","amount","email_format","status","payment_method","cc_trans_id","last_modified");  // supernova_registrations FIELDS -> GOOD LIST
	foreach($_POST as $key => $value)  								// FOR EACH KEY IN THE POST ARRAY SHOW ME THE VALUE
	{
...
function update_sn_reg()
{
	...
	$sn_reg_fields = array("seminar_event","showcase","meals","priority_code","category","amount","email_format","status","payment_method","cc_trans_id","last_modified");  // supernova_registration FIELDS -> GOOD LIST
	foreach($_POST as $key => $value)  								// FOR EACH KEY IN THE POST ARRAY SHOW ME THE VALUE
	{
		if($value != "" && in_array($key, $sn_reg_fields) == TRUE) 	// THERE IS A VALUE AND THE KEY IS IN THE GOOD LIST
		{
...
<img src="http://www.supernova2006.com/registration/images/palace_hotel.jpg" width="126" height="163" alt="Palace Hotel"></td><td width="34" valign="top"><img src="http://www.supernova2006.com/registration/images/yellow_line.gif" width="34" height="258" alt=""></td>
...
<td width="780" bgcolor="#FFFFFF">
	...
	<tr>
	<td width="304" height="155" valign="top"><a href="http://www.supernova2006.com"><img src="../images/logo.gif" width="304" height="155" alt="Home" border="0"></a></td>
