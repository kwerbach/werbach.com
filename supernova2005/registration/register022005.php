...
<!-- ----------------- ENTER MAIN CONTENT BELOW ------------------------ -->	<p><img src="../images/head_register.gif" width="502" height="50" alt="Register">
	<br>
...
<table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#FFCC99">
	<tr>
		<td><span class="form_label">
			...
			<br>
			You and all conference participants are invited to our kick-off networking event -- The <br>
			Wharton West Technology Showcase -- on Monday, June 20, from 5:30pm to 8:30pm at the Wharton West facility.<br>
			<br>
...
<p>	<table width="100%"  border="0" cellspacing="0">
	...
	<tr>
		<td class="form_label">Please enter special registration <strong>priority code</strong> here:
...
<!-- START CONTACT INFO -->	
	...
	<tr>
		<td width="110" align="right" class="form_label">Personal Weblog</td>
...
<table width="500">
	...
	<tr>
		<td colspan="2" class="form_label"> In addition to Credit Cards, registrations are also accepted via Bank Wire Transfer and Company Check drawn on US Funds. <br>
     			<br>
			Checks should be made payable to: <strong>Supernova Group</strong>. <br>
			<br>
...
<table>
	<tr>
		<td colspan="2" class="form_label"><strong>You may also submit registration information by fax</strong>. Please print out the registration form, complete it and fax it to: <strong>1-877-803-7101</strong>. <strong><br>
		      <br>
		      Hotel registration:</strong> please go to our <a href="../venue.htm">Venue</a> page for information on how to register for rooms at the Palace Hotel.<br>
			     <strong><br>
			Cancellation Policy:</strong> Written cancellations received before May 13, 2005 will be accepted subject to a service charge of $250. Subsequent cancellations are liable for the full-conference registration fee. Substitutions can be done at anytime prior to the conference. Please send email to <a href="mailto:info@supernovagroup.net">info@supernovagroup.net</a> if you would like to make a substitution.</td>
		</tr>
	<tr>
		<td class="form_label">&nbsp;</td>
		<td>&nbsp;</td>
