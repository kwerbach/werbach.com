...
?>
<table width="100%" cellpadding="0" cellspacing="0" bordercolor="#FF00FF">
  <tr>
    <td>
	  ...
	  print "
	   <tr>
		 <td width='10' class='$rowclass'>&nbsp;</td>
          ...
          <td class='$rowclass'><b>{$Row['last']}</b></td>
          <td class='$rowclass'><b>{$Row['first']}</b></td>
          <td class='$rowclass'><a class='datalink' href='people_edit_detail.php?key={$Row['ID']}&itemNumber=$newitemNumber'>{$Row['email']}</a></td>
