...
<table width="98%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF" class="data2">
  <tr>
    <td colspan="3" bgcolor="#FFFFFF">ID# &nbsp;
        <?=$ID?>
    </td>
    <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="29%" bgcolor="#FFFFFF"><div align="Center"><a class="button" href="mailing-label.php?key=<?=$key?>&itemNumber=<?=$itemNumber?>">show mailing label</a></td>
    <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
...
?>
  ...
  <tr>
    ...
    <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="29%" bgcolor="#FFFFFF">Twitter:
        <?=$twitter?>
    </td>
    <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
  ...
  <tr>
    ...
    <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="27%" bgcolor="#FFFFFF">Marketer?
      <?=$marketer?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="29%" bgcolor="#CCCCCC">Opt out?
        <font color="#CC0000"><?=$out_out?></font>
    </td>
    <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="27%" bgcolor="#FFFFFF">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="29%" bgcolor="#CCCCCC">Tags:
      <?= write_tags($HTTP_GET_VARS['key']); ?></td>
    <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="27%" bgcolor="#FFFFFF">&nbsp;</td>
  </tr>
  <tr>
