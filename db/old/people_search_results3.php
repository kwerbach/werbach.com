...
if ($total_records == 1)
{
	...
	header("Location: people_detail.php?key={$Row['ID']}&itemNumber=0");
	exit;
}
    ...
    <td>
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="strip">ID<br>sort <a class='orderby' href='people_search_results.php?asapOrder=user_id&screen=<?=$screen?>'>/\</a>
		  <a class='orderby' href='people_search_results.php?asapOrder=user_id&asapDesc=1&screen=<?=$screen?>'>\/</a></td>
