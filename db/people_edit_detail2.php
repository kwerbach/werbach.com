...
?></td>
    ...
    <tr>
      ...
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
      <td bgcolor="#FFFFFF">Werblist subscriber?
        <?
...
?>
  ...
  <input class="fields" type="text" name="fax" value="<?=$fax?>" size="15" tabindex=14></td>
      <td bgcolor="#FFFFFF">Skype:
        <input class="fields" type="text" name="skype" value="<?=$skype?>" size="15" tabindex=16></td>
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
...
<td colspan="3" bgcolor="#FFFFFF"><table width="400"  border="0" cellpadding="2" class="data2">
  <tr bgcolor="#FFFF99">
    <td>06 attendee      <?
if ( $sn_attendee06 == 1 )
{
?>
      <input type="checkbox" name="sn_attendee06" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_attendee06" value="1">
      <?
}
?></td>
    <td>06 speaker      <?
...
{
?>
      <input type="checkbox" name="sn_speaker06" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_speaker06" value="1">
      <?
}
?></td>
    <td>06 sponsor 
...
{
?>
      <input type="checkbox" name="sn_sponsor06" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_sponsor06" value="1">
      <?
}
?></td>
  </tr>
...
{
?>
      <input type="checkbox" name="sn_attendee05" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_attendee05" value="1">
      <?
}
?></td>
    <td>05 speaker 
...
{
?>
      <input type="checkbox" name="sn_speaker05" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_speaker05" value="1">
      <?
}
?></td>
    <td>05 sponsor <?
...
{
?>
      <input type="checkbox" name="sn_sponsor05" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_sponsor05" value="1">
      <?
}
?></td>
  </tr>
...
{
?>
      <input type="checkbox" name="sn_attendee04" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_attendee04" value="1">
      <?
}
?></td>
    <td>04 speaker
...
{
?>
      <input type="checkbox" name="sn_speaker04" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_speaker04" value="1">
      <?
}
?></td>
    <td>04 sponsor <?
...
{
?>
      <input type="checkbox" name="sn_sponsor04" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_sponsor04" value="1">
      <?
}
?> </td>
  </tr>
...
{
?>
      <input type="checkbox" name="sn_attendee03" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_attendee03" value="1">
      <?
}
?></td>
    <td>03 speaker
...
{
?>
      <input type="checkbox" name="sn_speaker03" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_speaker03" value="1">
      <?
}
?></td>
    <td>03 sponsor <?
...
{
?>
      <input type="checkbox" name="sn_sponsor03" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_sponsor03" value="1">
      <?
}
?></td>
  </tr>
...
{
?>
      <input type="checkbox" name="sn_attendee02" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_attendee02" value="1">
      <?
}
?></td>
    <td>02 speaker
...
{
?>
      <input type="checkbox" name="sn_speaker02" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_speaker02" value="1">
      <?
}
?></td>
    <td>02 sponsor
...
{
?>
      <input type="checkbox" name="sn_sponsor02" value="1" checked>
      <?
}
else
{
?>
      <input type="checkbox" name="sn_sponsor02" value="1">
      <?
}
?></td>
  </tr>
