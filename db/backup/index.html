        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
          ...
          <tr> 
            ...
            <span class="fieldname2">ID</span><br>
             <input class="fields" type="text" name="ID" value="">
          </td>
            <td width="2%" valign="top">&nbsp;</td>
            <td width="48%" valign="top"> 
            <span class="fieldname2">last</span><br>
             <input class="fields" type="text" name="last" value="">
          </td>
          </tr>
          <tr> 
            <td height="16" colspan="4" valign="top"> 
          ...
          <tr> 
            ...
            <span class="fieldname2">first</span><br>
             <input class="fields" type="text" name="first" value="">
          </td>
            <td width="2%" valign="top">&nbsp;</td>
            <td width="48%" valign="top"> 
          ...
          <tr> 
            ...
            <span class="fieldname2">company</span><br>
             <input class="fields" type="text" name="company" value="">
          </td>
            <td width="2%" valign="top">&nbsp;</td>
            <td width="48%" valign="top"> 
            <span class="fieldname2">phone</span><br>
             <input class="fields" type="text" name="phone" value="">
          </td>
          </tr>
        </table>
      </td>
