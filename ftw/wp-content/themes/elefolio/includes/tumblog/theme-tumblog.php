...
function woo_tumblog_default( $post_id = 0, $count = 0, $pagetype = '' ) {
	...
	<div class="post">
        ...
        <div class="posttype">
        	<a href="<?php echo $category_link; ?>" title="<?php __('Articles','woothemes'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/ico-text.png" alt="" /></a>
        </div><!-- /.posttype -->
...
function woo_tumblog_articles( $post_id = 0, $count = 0, $pagetype = '' ) {
	...
	<div class="post">
        ...
        <div class="posttype">
        	<a href="<?php echo $category_link; ?>" title="<?php echo esc_attr( get_post_format_string( get_post_format() ) ); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/ico-text.png" alt="" /></a>
        </div><!-- /.posttype -->
...
function woo_tumblog_videos( $post_id = 0, $count = 0, $pagetype = '' ) {
	...
	<div class="post video-post">
        ...
        <div class="posttype">
        	<a href="<?php echo $category_link; ?>" title="<?php echo esc_attr( get_post_format_string( get_post_format() ) ); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/ico-video.png" alt="" /></a>
        </div><!-- /.posttype -->
	    ...
	    <?php woo_post_meta(); ?>        
        <div class="media">
       	    <?php echo woo_get_embed('video-embed', '550', ''); ?>	
    	</div><!-- /.media --> 
...
function woo_tumblog_images( $post_id = 0, $count = 0, $pagetype = '' ) {
	...
	<div class="post image-post">
        ...
        <div class="posttype">
        	<a href="<?php echo $category_link; ?>" title="<?php echo esc_attr( get_post_format_string( get_post_format() ) ); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/ico-photo.png" alt="" /></a>
        </div><!-- /.posttype -->
...
function woo_tumblog_links( $post_id = 0, $count = 0, $pagetype = '' ) {
	...
	<div class="post">
        ...
        <div class="posttype">
        	<a href="<?php echo $category_link; ?>" title="<?php echo esc_attr( get_post_format_string( get_post_format() ) ); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/ico-link.png" alt="" /></a>
        </div><!-- /.posttype -->
...
function woo_tumblog_quotes( $post_id = 0, $count = 0, $pagetype = '' ) {
	...
	<div class="post quote-post">
		...
		<div class="posttype">
        	<a href="<?php echo $category_link; ?>" title="<?php echo esc_attr( get_post_format_string( get_post_format() ) ); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/ico-quote.png" alt="" /></a>
        </div><!-- /.posttype -->
...
function woo_tumblog_audio( $post_id = 0, $count = 0, $pagetype = '' ) {
	...
	<div class="post audio-post">
        ...
        <div class="posttype">
        	<a href="<?php echo $category_link; ?>" title="<?php echo esc_attr( get_post_format_string( get_post_format() ) ); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/ico-audio.png" alt="" /></a>
        </div><!-- /.posttype -->
