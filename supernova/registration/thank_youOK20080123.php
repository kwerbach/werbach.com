...
//TESTING		$ch = curl_init("https://certification.authorize.net/gateway/transact.dll"); // <-- USE THIS ONE FOR TESTING;	URL of gateway for cURL to post to 
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="wrapper">
    <div id="container">
      ...
      <div id="middlecolumn">
        <img src="http://www.supernova2007.com/i/alexandras_top.jpg" width="394" height="89" alt="Alexandra" />
        <h1>Supernova 2008</h1>  <!-- THINGS TO CHANGE YEAR TO YEAR -->
