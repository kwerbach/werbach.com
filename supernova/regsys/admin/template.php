...
//			alert(it);	// TESTING
		...
		* Load default page
		*/
//		$("#_loader").attr('src', 'jsloader.php?page=' + 'partials/conference.php');  // this would be the partial form				
//		$("#mainFormContent").load('partials/conference.php');
...
//	$("_mainContentFrame").load(str + '.php');
	...
	{
		$("#_mainContentFrame").attr('src', 'partials/' + arr[0] + '.php');
	}
