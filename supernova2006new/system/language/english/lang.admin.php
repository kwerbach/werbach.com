...
"This area enables you to manage your weblogs, preferences, and content-related sub-systems.",
...
"honor_entry_dst" =>
"Honor the Daylight Saving Time setting associated with each weblog entry?",
...
"%x trackback have been deleted",

"trackback_prune_x_days" =>
"Delete trackbacks that are more than X days old",

"prune_trackback_confirm_msg" =>
"Are you sure you want to delete the trackbacks you specified?",

"no_trackbacks_matched" =>
"There are no trackbacks matching the criteria you submitted",
...
"This feature will improve the speed at which your weblog pages load by caching queries that are normally executed dynamically.  Enable it only if you do not use the \"future entries\" or \"expiring entries\" feature.",
...
"By default, ExpressionEngine uses the word \"weblog\" throughout the control panel.  You can change it if you prefer something more generic, like \"section\".  Please note: This word will not change in your templates, only in the control panel.",
