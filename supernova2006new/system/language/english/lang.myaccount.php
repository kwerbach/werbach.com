...
"This page lets you add your own tabs to the main navigation of the control panel.  The tabs you add are viewable only by you.",
...
"To add a new tab, first visit the destination page, then click the \"New Tab\" link at the top right of the page.",
...
"Use this form to add personal links to the top toolbar.",
...
"weblog_name" =>
"Choose the weblog you want entries posted to",

"no_blogs_assigned_to_user" =>
"There are no weblogs assigned to this account.",
...
"You must submit the current password to update email address",
