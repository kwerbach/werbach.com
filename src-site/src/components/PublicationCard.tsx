...
export default function PublicationCard({ title, publication, year, link }: PublicationCardProps) {
      ...
      >
        ...
        <div className="relative z-10 flex-1 flex flex-col">
          ...
          <div className="mt-auto">
            {publication && (
              <p className="text-sm text-white/80 italic line-clamp-1">{publication}</p>
            )}
