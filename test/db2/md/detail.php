...
require_once('../Connections/phaktconn.php');

// begin Recordset
$colname__Recordset1 = '-1';
if (isset($HTTP_GET_VARS['recordID'])) {
  $colname__Recordset1 = $HTTP_GET_VARS['recordID'];
}
$query_Recordset1 = sprintf("SELECT * FROM employees_emp WHERE id_emp = %s", $colname__Recordset1);
